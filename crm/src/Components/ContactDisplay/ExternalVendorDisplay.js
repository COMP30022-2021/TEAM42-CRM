...
export default function ExternalVendorDisplay() {
    const nextContact = () => {
      ...
      return (
          ...
          <p1 className = "p3" style={{position: "absolute",
            left: "50%",transform: "translate(-50%, -50%)",
          top:'44%','font-size':20}}>Role: External Vendor</p1>
          ...
          <ImPriceTags style={{position: "absolute",
            left: "15%",
          top: '71.25%'}}/> 
          <p1 className = "p3" style={{position: "absolute",
            left: "17%",
          top:'71%'}}>Tags: {contact.tags} </p1>
          
          <BiDollar style={{position: "absolute",
            left: "15%",
          top: '76.25%'}}/> 
          <p1 className = "p3" style={{position: "absolute",
            left: "17%",
          top:'76%'}}>{contact.cost} </p1>
            </div>    
